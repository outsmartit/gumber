...
JHtml::addIncludePath(JPATH_THEMES .'/gumber/helpers');
		...
		<?php if ($canEdit ||  $params->get('show_print_icon') || $params->get('show_email_icon')) : ?>
			<ul class="actions">
				<?php if ($params->get('show_print_icon')) : ?>
					<li class="print"> <?php echo JHtml::_('gumbericon.print_popup',  $this->item, $params); ?> </li>
				<?php endif; ?>
				<?php if ($params->get('show_email_icon')) : ?>
					<li class="email"> <?php echo JHtml::_('gumbericon.email',  $this->item, $params); ?> </li>
				<?php endif; ?>
				<?php if ($canEdit) : ?>
					<li class="edit"> <?php echo JHtml::_('gumbericon.edit', $this->item, $params); ?> </li>
				<?php endif; ?>
			</ul>
		<?php endif; ?>
	<?php endif; ?>
	...
	<section>
		<ul class="article-info inline">
			...
			<?php if ($params->get('show_publish_date')) : ?>
                                        <li class="published"><i class="icon-calendar"></i>
			...
			<?php if ($info == 0): ?>
				...
				<?php if ($params->get('show_hits')) : ?>
					<li class="hits"><i class="icon-eye"></i>
